...
const Guide = () => {
  ...
  <div style={{
    width:"5%",
    height:"5px",
    backgroundColor:"#00339",
    margin:"0 auto",
  }}>

  </div>
  <Typography variant="h3" sx={{fontSize:"35px",fontWeight:"bold",color:"#00339",my:3}}>
    How it Works?
  </Typography>

  <CustomBox>
    <Typography variant="body2" sx={{fontSize:"16px",fontWeight:"500",color:"#5A6473",textAlign:"center"}}>
      Everything you need to know when you want to buy, rent or sell - Al
      in one place
    </Typography>
  </CustomBox>
